...
//		} */
//			
//		//another workaround by chatGPT for stale element exception
//		int attempts = 0;
//		while (attempts < 3) {
//		    try {
//		        WebElement beer = driver.findElement(By.xpath("//span[contains(text(), 'Bier')]"));
...
//		Thread.sleep(1000);
//		shadow.findElement(By.cssSelector(" div:nth-child(8) > section:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > a:nth-child(1)")).click(); */
//		
//		//This Element is inside single shadow DOM.
//		//This Element is inside single shadow DOM.
//		String cssSelectorFaorHost1 = "body > div:nth-child(6) > div:nth-child(4) > main:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(3) > mfe-products-display:nth-child(1)";
//		Thread.sleep(1000);
//		SearchContext shadow = driver.findElement(By.cssSelector("body > div:nth-child(6) > div:nth-child(4) > main:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(3) > mfe-products-display:nth-child(1)")).getShadowRoot();
//		Thread.sleep(1000);
//		shadow.findElement(By.cssSelector(" div:nth-child(8) > section:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(4) > div:nth-child(2) > button:nth-child(2) > img:nth-child(1)")).sendKeys(Keys.ENTER);
//
//		
